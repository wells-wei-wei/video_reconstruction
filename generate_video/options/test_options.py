...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self._parser.add_argument('--src_path', type=str, default='./assets/src_imgs/fashion_woman/Sweaters-id_0000088807_4_full.jpg', help='source image path 原图')
        self._parser.add_argument('--tgt_path', type=str, default='./assets/samples/refs/iPER/024_8_2', help='target image path 动作')
...
'''
        ...
        self._parser.add_argument('--bg_ks', default=25, type=int, help='dilate kernel size of background mask.')
        ...
        self._parser.add_argument('--has_detector', action='store_true', default=False, help='use mask rcnn or not')
